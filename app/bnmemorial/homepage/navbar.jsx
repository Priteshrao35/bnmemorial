...
const Navbar = () => {
  ...
  return (
    <div className="bg-white hidden fixed md:mt-14 md:flex z-50 justify-center items-center space-x-4 w-full text-sm p-2 cursor-pointer"> {/* Decreased text size to text-sm */}
